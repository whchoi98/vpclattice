...
echo "export CLUSTER2_VPC_ID=$(aws ec2 describe-vpcs --filters Name=tag:Name,Values=$VPC2_NAME | jq -r '.Vpcs[].VpcId')" | tee -a ~/.bash_profile
...
echo "export RATES_PublicSubnet03=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=LatticeWorkshop-Rates-PublicSubnet03' | jq -r '.Subnets[].SubnetId')" | tee -a ~/.bash_profile
echo "export RATES_PrivateSubnet01=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=LatticeWorkshop-Rates-PrivateSubnet01' | jq -r '.Subnets[].SubnetId')" | tee -a ~/.bash_profile
echo "export RATES_PrivateSubnet02=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=LatticeWorkshop-Rates-PrivateSubnet02' | jq -r '.Subnets[].SubnetId')" | tee -a ~/.bash_profile
echo "export RATES_PrivateSubnet03=$(aws ec2 describe-subnets --filters 'Name=tag:Name,Values=LatticeWorkshop-Rates-PrivateSubnet03' | jq -r '.Subnets[].SubnetId')" | tee -a ~/.bash_profile
...
vpc: 
  ...
  subnets:
    public:
      PublicSubnet01:
        az: ${AWS_REGION}a
        id: ${RATES_PublicSubnet01}
      PublicSubnet02:
        az: ${AWS_REGION}b
        id: ${RATES_PublicSubnet02}
      PublicSubnet03:
        az: ${AWS_REGION}c
        id: ${RATES_PublicSubnet03}
    private:
      PrivateSubnet01:
        az: ${AWS_REGION}a
        id: ${RATES_PrivateSubnet01}
      PrivateSubnet02:
        az: ${AWS_REGION}b
        id: ${RATES_PrivateSubnet02}
      PrivateSubnet03:
        az: ${AWS_REGION}c
        id: ${RATES_PrivateSubnet03}
...
- name: nodegroup
  ...
  subnets:
    - ${RATES_PrivateSubnet01}
    - ${RATES_PrivateSubnet02}
    - ${RATES_PrivateSubnet03}
  volumeSize: 20
  volumeType: gp3
...
eksctl create cluster -f lattice_eks02.yaml --dry-run
